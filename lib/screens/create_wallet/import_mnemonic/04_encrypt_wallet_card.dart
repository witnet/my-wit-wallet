...
class EncryptWalletCardState extends State<EncryptWalletCard>  with TickerProviderStateMixin {
  void onBack() => BlocProvider.of<BlocImportMnemonic>(context).add(PreviousCardEvent());
  ...
  Widget _buildInfoText(ThemeData theme ){
    return Column(
      ...
      children: [
        ...
        Text('PLEASE NOTE: this password encrypts your Witnet wallet only on this computer. This is not your backup and you cannot restore your wallet with this password. Your ${Locator.instance.get<ApiCreateWallet>().seedData.split(' ').length} word seed phrase is still your ultimate recovery method.',
          style: TextStyle(
            fontSize: 14,
            ...
            Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('Enabling this will ensure: minimum length 8, 2 uppercase letters, 1 special case !@#\$&*, 2 digits, and 3 lowercase letters. ',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
                      ),),
