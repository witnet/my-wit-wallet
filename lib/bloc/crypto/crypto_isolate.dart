...
class CryptoIsolate {
  ...
  Future<dynamic> send(
    ...
    print('SEND ISOLATE method: $method, is initialized? $initialized');
    try {
      return await Isolate.run(isolateFunction);
    } catch (err) {
      print('SEND ISOLATE error: $err');
      logger.log('Error in cryptoIsolate $method : $err');
      rethrow;
    }
  }
}
...
Future<String> _generateMnemonic(Map<String, dynamic> params) async {
